...
<!-- MORE -->
Compare to Ubuntu, Kubuntu 22.04's *System Settings* includes most of the settings, which means I don't need to install something like Gnome Tweak, dconf-editor or Gnome extensions. However, this doesn't mean I will do less settings than that in Ubuntu.
...
![](https://cdn.jsdmirror.com/gh/dqwyy/blog-img/0004/01.png)
